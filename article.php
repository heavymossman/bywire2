...
<div class="container-fluid  ">
   <div class="row">
      ...
      <div class="col-md-9 col-xs-10 grey-bk round-borders-left">
         <article name="blockchain-verification">
      ...
      <div class="col-md-9">
         <div class="row hidden-mobile">
            ...
            <div class="col-md-2 mt-5">
               <address class="author"><p style="margin-top: 2.21rem;"><small>By <a class="red-text" rel="author" href="#">Darren Doe</a></small></p></address>
         ...
         <address class="author"><p><small>By <a rel="author" href="#" class="red-text">Darren Hunt</a></small></p></address>
         <button type="button" data-toggle="modal" data-target=".exampleModalCenter" class="btn btn-bywire btn-lg"><img src="images/wb-logo.png"> Reward</button>
         </div>
         </div>
      </div>
